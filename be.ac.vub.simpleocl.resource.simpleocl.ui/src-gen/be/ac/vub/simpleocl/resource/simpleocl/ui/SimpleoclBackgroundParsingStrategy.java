...
public class SimpleoclBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, final be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, final be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, final be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
