...
public class SimpleoclBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private String BRACKETS_COLOR = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName();
	
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBracketSet bracketsTmp;
	...
	public SimpleoclBracketPreferencePage() {
		...
		be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclMetaInformation metaInformation = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.getDefault().getPreferenceStore());
		setDescription("Define the coloring of matching brackets.");
		
		bracketsTmp = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor) {
			((be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor) editor).invalidateTextRepresentation();
		}
	}
