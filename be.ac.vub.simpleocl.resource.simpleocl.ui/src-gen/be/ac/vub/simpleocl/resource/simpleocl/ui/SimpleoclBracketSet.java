...
public class SimpleoclBracketSet {
	...
	private java.util.ArrayList<be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair {
	 ...
	 */
	private class ClosingListener implements be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public SimpleoclBracketSet(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair>();
	 ...
	 */
	public be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair getBracketPair(String opening, String closing) {
		for (be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair : bracketPairs) {
	...
	public be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair remove(String opening, String closing) {
		for (be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
