...
public class SimpleoclBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput);
		...
		fInput= (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) input;
		...
		be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput getInput() {
		return fInput;
	}
