...
public class SimpleoclCodeFoldingManager {
	...
	private class FoldingUpdateListener implements be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor) {
				be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor = (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor) workbenchPart;
	...
	protected be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor;
	 ...
	 */
	public SimpleoclCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor textEditor) {
	...
	private void addCloseListener(final be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
	...
	protected void calculatePositions() {
		be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource textResource = (be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
