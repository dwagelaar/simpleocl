 ...
 */
public class SimpleoclCompletionProposal implements java.lang.Comparable<SimpleoclCompletionProposal> {
	...
	public SimpleoclCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public SimpleoclCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public SimpleoclCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof SimpleoclCompletionProposal) {
			SimpleoclCompletionProposal other = (SimpleoclCompletionProposal) object;
	...
	public int compareTo(SimpleoclCompletionProposal object) {
		if (object instanceof SimpleoclCompletionProposal) {
			SimpleoclCompletionProposal other = (SimpleoclCompletionProposal) object;
