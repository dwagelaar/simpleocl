 ...
 * olInput</code>.
 */
public class SimpleoclDocBrowserInformationControlInput {
	
	private final SimpleoclDocBrowserInformationControlInput fPrevious;
	private SimpleoclDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SimpleoclDocBrowserInformationControlInput(SimpleoclDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SimpleoclDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SimpleoclDocBrowserInformationControlInput getNext() {
		return fNext;
	}
