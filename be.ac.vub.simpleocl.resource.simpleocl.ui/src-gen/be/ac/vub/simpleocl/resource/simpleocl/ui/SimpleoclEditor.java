...
public class SimpleoclEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclResourceProvider, be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandlerProvider, be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclAnnotationModelProvider {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclCodeFoldingManager codeFoldingManager;
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBackgroundParsingStrategy bgParsingStrategy = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBackgroundParsingStrategy();
	private java.util.Collection<be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener>();
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclColorManager colorManager = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclColorManager();
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclOutlinePage outlinePage;
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPropertySheetPage propertySheetPage;
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler bracketHandler;
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource currentResource = getResource();
				...
				be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("be.ac.vub.simpleocl.resource.simpleocl.EditorContext");
		setRulerContextMenuId("be.ac.vub.simpleocl.resource.simpleocl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclNature.activate(inputFile.getProject());
		...
		be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource loadedResource = (be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource) {
					setResource((be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SimpleoclEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextToken token = lexer.getNextToken();
			...
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler bracketHandler) {
