...
public class SimpleoclHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionHelper positionHelper = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionHelper();
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclTokenScanner scanner;
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclOccurrence occurrence;
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public SimpleoclHighlighting(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclColorManager colorManager, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclTokenScanner(textResource, colorManager);
		occurrence = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
