...
public class SimpleoclOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclNameProvider nameProvider = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().createNameProvider();
