...
public class SimpleoclSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	 ...
	 */
	public SimpleoclSourceViewerConfiguration(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclResourceProvider resourceProvider, be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclAnnotationModelProvider annotationModelProvider, be.ac.vub.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandlerProvider bracketHandlerProvider, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclColorManager colorManager) {
		super(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.getDefault().getPreferenceStore());
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
