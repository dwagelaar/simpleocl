...
public class SimpleoclSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPixelConverter pixelConverter = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor) {
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor emfTextEditor = (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclEditor) editor;
