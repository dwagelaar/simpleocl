...
public class SimpleoclTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput infoInput = (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHyperlink hyperlink = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl iControl = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) {
							be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput input = (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl.isAvailable(parent)) {
				be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl iControl = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public SimpleoclTextHover(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.insertPageProlog(buffer, 0, be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclTextHover.getStyleSheet());
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.addPageEpilog(buffer);
			return new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclStreamUtil.getContent(styleSheetURL.openStream());
