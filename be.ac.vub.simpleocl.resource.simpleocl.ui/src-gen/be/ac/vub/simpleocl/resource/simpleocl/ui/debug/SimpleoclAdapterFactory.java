...
public class SimpleoclAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName())) {
					return new be.ac.vub.simpleocl.resource.simpleocl.ui.debug.SimpleoclLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugVariable) {
			final be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugVariable variable = (be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugVariable) {
			final be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugVariable variable = (be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugValue castedValue = (be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugValue) value;
