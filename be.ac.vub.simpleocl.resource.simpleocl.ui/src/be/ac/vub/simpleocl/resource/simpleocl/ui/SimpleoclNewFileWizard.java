...
public class SimpleoclNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclNewFileWizardPage page;
	...
	public void addPages() {
		page = new be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			be.ac.vub.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName();
	}
