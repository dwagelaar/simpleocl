 ...
 */
public class SimpleoclNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public SimpleoclNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new simpleocl file");
