...
public class SimpleoclNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("be.ac.vub.simpleocl.resource.simpleocl.ui");
							...
							String natureID = be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclNature.NATURE_ID;
							...
							for (String builderID : be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation info = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation();
