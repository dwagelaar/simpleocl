...
public interface ISimpleoclOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getResourcePostProcessorProviderOptionKey();
