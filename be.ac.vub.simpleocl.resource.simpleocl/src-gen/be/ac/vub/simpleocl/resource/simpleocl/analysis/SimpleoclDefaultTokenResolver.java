 ...
 */
public class SimpleoclDefaultTokenResolver implements be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclGrammarInformationProvider.INSTANCE.getKeywords()) {
