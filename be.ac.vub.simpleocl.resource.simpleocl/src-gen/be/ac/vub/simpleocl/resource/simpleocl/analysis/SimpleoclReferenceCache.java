 ...
 * given name.
 */
public class SimpleoclReferenceCache extends org.eclipse.emf.common.notify.impl.AdapterImpl implements be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclReferenceCache {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclNameProvider nameProvider;
	
	public SimpleoclReferenceCache(be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclNameProvider nameProvider) {
		super();
