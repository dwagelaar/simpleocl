...
public class SimpleoclDebugValue extends be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public SimpleoclDebugValue(be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
