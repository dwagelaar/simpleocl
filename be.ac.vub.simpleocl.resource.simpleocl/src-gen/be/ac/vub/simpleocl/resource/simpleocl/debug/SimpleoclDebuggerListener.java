...
public class SimpleoclDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.debug.AbstractSimpleoclDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object>>();
	...
	private void runDebugger() throws java.io.IOException {
		...
		be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.encode('#', stack);
				be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage message = new be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage message = new be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_VARIABLES)) {
				...
				be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage message = new be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage(be.ac.vub.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object> pair = new be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object>(name, value);
	...
	public be.ac.vub.simpleocl.resource.simpleocl.debug.AbstractSimpleoclDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(be.ac.vub.simpleocl.resource.simpleocl.debug.AbstractSimpleoclDebuggable debuggable) {
