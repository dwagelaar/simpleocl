...
public class SimpleoclStackFrame extends be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target;
	private String name;
	private int id;
	...
	public SimpleoclStackFrame(be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.decode(data, ',');
	...
	private be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclStackFrame other = (be.ac.vub.simpleocl.resource.simpleocl.debug.SimpleoclStackFrame) obj;
		if (name == null) {
