...
public class SimpleoclExpectedTerminal {
	...
	private be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclContainmentTrace containmentTrace;
	
	public SimpleoclExpectedTerminal(org.eclipse.emf.ecore.EObject container, be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclExpectedElement terminal, int followSetID, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclContainmentTrace containmentTrace) {
		super();
	...
	public be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclExpectedElement getTerminal() {
		return terminal;
	}
	...
	public be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclContainmentTrace getContainmentTrace() {
