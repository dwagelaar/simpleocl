...
public class SimpleoclLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations = new java.util.ArrayList<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation>();
	...
	public java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation) {
