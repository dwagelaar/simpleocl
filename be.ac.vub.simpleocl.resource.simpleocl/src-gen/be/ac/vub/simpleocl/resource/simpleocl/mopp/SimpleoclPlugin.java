 ...
 */
public class SimpleoclPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "be.ac.vub.simpleocl.resource.simpleocl";
	/**
	...
	private static SimpleoclPlugin plugin;
	
	public SimpleoclPlugin() {
		super();
	}
	...
	public static SimpleoclPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimpleoclPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimpleoclPlugin.PLUGIN_ID, message);
		}
		final SimpleoclPlugin pluginInstance = SimpleoclPlugin.getDefault();
