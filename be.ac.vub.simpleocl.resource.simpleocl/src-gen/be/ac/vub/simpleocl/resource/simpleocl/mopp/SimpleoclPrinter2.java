...
public class SimpleoclPrinter2 implements be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclTextPrinter {
	 ...
	 */
	public boolean decorateTreeBasic(be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclSyntaxElementDecorator decorator, org.eclipse.emf.ecore.EObject eObject, java.util.Map<String, Integer> printCountingMap, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclSyntaxElementDecorator> keywordsToPrint) {
	 ...
	 */
	public boolean doesPrintFeature(be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclSyntaxElementDecorator decorator, org.eclipse.emf.ecore.EObject eObject, java.util.Map<String, Integer> printCountingMap) {
		be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclSyntaxElement syntaxElement = decorator.getDecoratedElement();
	...
	public void printKeyword(org.eclipse.emf.ecore.EObject eObject, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclKeyword keyword, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations) {
		be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = getLayoutInformation(layoutInformations, keyword, null, eObject);
		printFormattingElements(foundFormattingElements, layoutInformations, layoutInformation);
		String value = keyword.getValue();
		tokenOutputStream.add(new PrintToken(value, "'" + be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.escapeToANTLRKeyword(value) + "'"));
	}
	...
	public void printAttribute(org.eclipse.emf.ecore.EObject eObject, org.eclipse.emf.ecore.EAttribute attribute, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclPlaceholder placeholder, int count, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations) {
		String result;
		Object attributeValue = getValue(eObject, attribute, count);
		be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = getLayoutInformation(layoutInformations, placeholder, attributeValue, eObject);
	...
	public void printBooleanTerminal(org.eclipse.emf.ecore.EObject eObject, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclBooleanTerminal booleanTerminal, int count, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations) {
		org.eclipse.emf.ecore.EAttribute attribute = booleanTerminal.getAttribute();
		String result;
		Object attributeValue = getValue(eObject, attribute, count);
		be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = getLayoutInformation(layoutInformations, booleanTerminal, attributeValue, eObject);
		String visibleTokenText = getVisibleTokenText(layoutInformation);
		// if there is text for the attribute we use it
		if (visibleTokenText != null) {
			result = visibleTokenText;
		...
		if (result != null && !"".equals(result)) {
			printFormattingElements(foundFormattingElements, layoutInformations, layoutInformation);
			// write result to the output stream
			tokenOutputStream.add(new PrintToken(result, "'" + be.ac.vub.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.escapeToANTLRKeyword(result) + "'"));
		}
	}
	
	
	public void printEnumerationTerminal(org.eclipse.emf.ecore.EObject eObject, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclEnumerationTerminal enumTerminal, int count, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations) {
		org.eclipse.emf.ecore.EAttribute attribute = enumTerminal.getAttribute();
		String result;
		Object attributeValue = getValue(eObject, attribute, count);
		be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = getLayoutInformation(layoutInformations, enumTerminal, attributeValue, eObject);
		String visibleTokenText = getVisibleTokenText(layoutInformation);
		// if there is text for the attribute we use it
		if (visibleTokenText != null) {
			result = visibleTokenText;
	...
	public void printContainedObject(org.eclipse.emf.ecore.EObject eObject, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclContainment containment, int count, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations) {
	...
	public void printFormattingElements(java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations, be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation) {
	...
	public void printReference(org.eclipse.emf.ecore.EObject eObject, org.eclipse.emf.ecore.EReference reference, be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclPlaceholder placeholder, int count, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.grammar.SimpleoclFormattingElement> foundFormattingElements, java.util.List<be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> layoutInformations) {
		String tokenName = placeholder.getTokenName();
		Object referencedObject = getValue(eObject, reference, count);
		// first add layout before the reference
		be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = getLayoutInformation(layoutInformations, placeholder, referencedObject, eObject);
		printFormattingElements(foundFormattingElements, layoutInformations, layoutInformation);
