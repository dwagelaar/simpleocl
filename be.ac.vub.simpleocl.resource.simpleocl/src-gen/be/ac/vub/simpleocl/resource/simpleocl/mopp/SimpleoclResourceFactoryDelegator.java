...
public class SimpleoclResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public SimpleoclResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new be.ac.vub.simpleocl.resource.simpleocl.mopp.SimpleoclResourceFactory());
		}
	}
