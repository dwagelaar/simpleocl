...
public class SimpleoclStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, be.ac.vub.simpleocl.resource.simpleocl.ISimpleoclFunction1<String, T> toStringFunction) {
