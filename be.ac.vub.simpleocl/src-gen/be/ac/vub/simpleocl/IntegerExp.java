 ...
 * <ul>
 *   <li>{@link be.ac.vub.simpleocl.IntegerExp#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @see be.ac.vub.simpleocl.SimpleoclPackage#getIntegerExp()
 * @model
 * @generated
 */
public interface IntegerExp extends NumericExp {
	 ...
	 * @see be.ac.vub.simpleocl.SimpleoclPackage#getIntegerExp_IntegerSymbol()
	 * @model unique="false" dataType="be.ac.vub.simpleocl.Integer" required="true" ordered="false"
	 * @generated
	 */
	int getIntegerSymbol();

	/**
	 * Sets the value of the '{@link be.ac.vub.simpleocl.IntegerExp#getIntegerSymbol <em>Integer Symbol</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
