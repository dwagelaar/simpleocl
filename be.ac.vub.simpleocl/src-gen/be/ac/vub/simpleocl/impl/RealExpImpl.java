 ...
 * <ul>
 *   <li>{@link be.ac.vub.simpleocl.impl.RealExpImpl#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealExpImpl extends NumericExpImpl implements RealExp {
	...
	protected EClass eStaticClass() {
		return SimpleoclPackage.Literals.REAL_EXP;
	}
	...
	public void setRealSymbol(double newRealSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleoclPackage.REAL_EXP__REAL_SYMBOL, oldRealSymbol, realSymbol));
	}
