...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simpleocl.CollectionItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CollectionItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CollectionItem_item_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CollectionItem_item_feature", "_UI_CollectionItem_type"),
				 SimpleoclPackage.Literals.COLLECTION_ITEM__ITEM,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_CollectionItem_type") + " " + collectionItem.getLine();
	}
