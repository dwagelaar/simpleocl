...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simpleocl.LambdaType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LambdaTypeItemProvider
	 ...
	 * @generated
	 */
	public LambdaTypeItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleoclPackage.Literals.LAMBDA_TYPE__RETURN_TYPE);
			childrenFeatures.add(SimpleoclPackage.Literals.LAMBDA_TYPE__ARGUMENT_TYPES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LambdaType"));
	}
	...
	public String getText(Object object) {
		String label = ((LambdaType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LambdaType_type") :
			getString("_UI_LambdaType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LambdaType.class)) {
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == SimpleoclPackage.Literals.LAMBDA_TYPE__RETURN_TYPE ||
			childFeature == SimpleoclPackage.Literals.LAMBDA_TYPE__ARGUMENT_TYPES;
