...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simpleocl.OclType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OclTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OclType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OclType_name_feature", "_UI_OclType_type"),
				 SimpleoclPackage.Literals.OCL_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((OclType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_OclType_type") :
			getString("_UI_OclType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OclType.class)) {
