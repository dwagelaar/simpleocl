...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simpleocl.StaticOperationCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StaticOperationCallItemProvider
	extends StaticPropertyCallItemProvider
	implements
	 ...
	 * @generated
	 */
	public StaticOperationCallItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StaticOperationCall_operationName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StaticOperationCall_operationName_feature", "_UI_StaticOperationCall_type"),
				 SimpleoclPackage.Literals.STATIC_OPERATION_CALL__OPERATION_NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleoclPackage.Literals.STATIC_OPERATION_CALL__ARGUMENTS);
		}
	...
	/**
	 * This returns StaticOperationCall.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StaticOperationCall"));
	}
	...
	public String getText(Object object) {
		String label = ((StaticOperationCall)object).getOperationName();
		return label == null || label.length() == 0 ?
			getString("_UI_StaticOperationCall_type") :
			getString("_UI_StaticOperationCall_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StaticOperationCall.class)) {
			case SimpleoclPackage.STATIC_OPERATION_CALL__OPERATION_NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case SimpleoclPackage.STATIC_OPERATION_CALL__ARGUMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimpleoclPackage.Literals.STATIC_OPERATION_CALL__ARGUMENTS,
