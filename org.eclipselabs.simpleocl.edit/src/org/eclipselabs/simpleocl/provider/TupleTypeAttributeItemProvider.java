...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.simpleocl.TupleTypeAttribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TupleTypeAttributeItemProvider
	 ...
	 * @generated
	 */
	public TupleTypeAttributeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TupleTypeAttribute_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TupleTypeAttribute_name_feature", "_UI_TupleTypeAttribute_type"),
				 SimpleoclPackage.Literals.TUPLE_TYPE_ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimpleoclPackage.Literals.TUPLE_TYPE_ATTRIBUTE__TYPE);
		}
	...
	/**
	 * This returns TupleTypeAttribute.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TupleTypeAttribute"));
	}
	...
	public String getText(Object object) {
		String label = ((TupleTypeAttribute)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TupleTypeAttribute_type") :
			getString("_UI_TupleTypeAttribute_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TupleTypeAttribute.class)) {
