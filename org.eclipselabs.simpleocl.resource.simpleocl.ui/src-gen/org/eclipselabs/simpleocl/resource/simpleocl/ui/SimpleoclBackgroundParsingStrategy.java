 ...
 */
public class SimpleoclBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, final org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, final org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, final org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource) {
							org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource concreteResource = (org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource) resource;
