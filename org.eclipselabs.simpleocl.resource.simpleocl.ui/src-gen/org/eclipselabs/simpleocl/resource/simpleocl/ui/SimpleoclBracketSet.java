 ...
 */
public class SimpleoclBracketSet {
	...
	private java.util.ArrayList<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair {
	 ...
	 */
	private class ClosingListener implements org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public SimpleoclBracketSet(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair>();
	 ...
	 */
	public org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair getBracketPair(String opening, String closing) {
		for (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair : bracketPairs) {
	...
	public org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair remove(String opening, String closing) {
		for (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
