 ...
 * @since 3.2
 */
public class SimpleoclBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput fInput;
	 ...
	 */
	public SimpleoclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public SimpleoclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public SimpleoclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput);
		...
		fInput= (org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) input;
		...
		org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput getInput() {
		return fInput;
	}
