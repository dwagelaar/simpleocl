 ...
 */
public class SimpleoclCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor) {
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor = (org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor) workbenchPart;
	...
	protected org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor;
	 ...
	 */
	public SimpleoclCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor textEditor) {
	...
	private void addCloseListener(final org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource textResource = (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
