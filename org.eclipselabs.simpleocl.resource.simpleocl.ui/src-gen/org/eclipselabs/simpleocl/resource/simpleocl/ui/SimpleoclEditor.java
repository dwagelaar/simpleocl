 ...
 * <p>
 * This editor has id
 * <code>org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor</code>
 * The editor's context menu has id
 * <code>org.eclipselabs.simpleocl.resource.simpleocl.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.eclipselabs.simpleocl.resource.simpleocl.EditorRuler</code>.
 * </p>
 */
public class SimpleoclEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclResourceProvider, org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandlerProvider, org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclAnnotationModelProvider {
	
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclCodeFoldingManager codeFoldingManager;
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBackgroundParsingStrategy bgParsingStrategy = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBackgroundParsingStrategy();
	private java.util.Collection<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener>();
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclColorManager colorManager = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclColorManager();
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclOutlinePage outlinePage;
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPropertySheetPage propertySheetPage;
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler bracketHandler;
	...
	public SimpleoclEditor() {
		super();
		setSourceViewerConfiguration(new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclSourceViewerConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), SimpleoclEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource currentResource = getResource();
				...
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.eclipselabs.simpleocl.resource.simpleocl.EditorContext");
		setRulerContextMenuId("org.eclipselabs.simpleocl.resource.simpleocl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclNature.activate(inputFile.getProject());
		...
		org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource loadedResource = (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) {
					setResource((org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SimpleoclEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource textResource = (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) element.eResource();
			org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextToken token = lexer.getNextToken();
			...
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!SimpleoclEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource)) {
					return false;
				}
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource textResource = (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) resource;
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;
