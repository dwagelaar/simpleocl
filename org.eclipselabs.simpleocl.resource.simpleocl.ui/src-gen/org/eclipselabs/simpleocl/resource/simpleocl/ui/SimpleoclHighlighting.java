 ...
 */
public class SimpleoclHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionHelper positionHelper = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionHelper();
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclTokenScanner scanner;
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclOccurrence occurrence;
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public SimpleoclHighlighting(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclColorManager colorManager, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclTokenScanner(textResource, colorManager);
		occurrence = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
