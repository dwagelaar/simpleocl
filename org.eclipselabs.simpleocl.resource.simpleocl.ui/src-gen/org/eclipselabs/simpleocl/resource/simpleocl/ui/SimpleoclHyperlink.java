 ...
 */
public class SimpleoclHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public SimpleoclHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
