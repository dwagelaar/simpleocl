...
public class SimpleoclHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public SimpleoclHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
