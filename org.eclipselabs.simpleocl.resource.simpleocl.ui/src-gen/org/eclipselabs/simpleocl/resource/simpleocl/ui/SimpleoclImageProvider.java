 ...
 */
public class SimpleoclImageProvider {
	
	public final static SimpleoclImageProvider INSTANCE = new SimpleoclImageProvider();
	...
	public org.eclipse.jface.resource.ImageDescriptor getImageDescriptor(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
