	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource) {
					org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource customResource = (org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclQuickFix> getQuickFixes(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
