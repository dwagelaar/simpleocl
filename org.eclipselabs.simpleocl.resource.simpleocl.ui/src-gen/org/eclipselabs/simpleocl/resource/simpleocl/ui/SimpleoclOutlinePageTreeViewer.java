 ...
 * a specified depth.
 */
public class SimpleoclOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public SimpleoclOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.logError("Exception while refreshing outline view", e);
		}
	}
