 ...
 */
public class SimpleoclSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public SimpleoclSourceViewerConfiguration(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclResourceProvider resourceProvider, org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclAnnotationModelProvider annotationModelProvider, org.eclipselabs.simpleocl.resource.simpleocl.ui.ISimpleoclBracketHandlerProvider bracketHandlerProvider, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclColorManager colorManager) {
		super(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}
