 ...
 */
public class SimpleoclTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput infoInput = (org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHyperlink hyperlink = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl iControl = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) {
							org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput input = (org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl.isAvailable(parent)) {
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl iControl = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public SimpleoclTextHover(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.insertPageProlog(buffer, 0, org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclTextHover.getStyleSheet());
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.addPageEpilog(buffer);
			return new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStreamUtil.getContent(styleSheetURL.openStream());
