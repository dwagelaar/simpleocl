 ...
 */
public class SimpleoclUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.eclipselabs.simpleocl.resource.simpleocl.ui";
	public static final String EDITOR_ID = "org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclEditor";
	...
	private static SimpleoclUIPlugin plugin;
	
	public SimpleoclUIPlugin() {
		super();
	}
	...
	public static SimpleoclUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimpleoclUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SimpleoclUIPlugin.PLUGIN_ID, message);
		}
		final SimpleoclUIPlugin pluginInstance = SimpleoclUIPlugin.getDefault();
