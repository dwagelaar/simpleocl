...
public class SimpleoclNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public SimpleoclNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.eclipselabs.simpleocl.resource.simpleocl.ui.SimpleoclUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName();
	}
