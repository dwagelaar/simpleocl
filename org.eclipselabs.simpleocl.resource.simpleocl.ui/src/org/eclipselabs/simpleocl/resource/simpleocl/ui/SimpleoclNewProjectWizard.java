 ...
 */
public class SimpleoclNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public SimpleoclNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.eclipselabs.simpleocl.resource.simpleocl.ui");
							...
							String natureID = org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclNature.NATURE_ID;
							...
							for (String builderID : org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation info = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation();
