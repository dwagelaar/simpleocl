 ...
 */
public interface ISimpleoclOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation().getResourcePostProcessorProviderOptionKey();
