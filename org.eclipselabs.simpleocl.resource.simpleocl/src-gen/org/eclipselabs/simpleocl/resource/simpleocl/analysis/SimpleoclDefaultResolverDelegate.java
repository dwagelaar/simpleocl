...
public class SimpleoclDefaultResolverDelegate<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	...
	private static org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation metaInformation = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclMetaInformation();
	
	private org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclNameProvider nameProvider = metaInformation.createNameProvider();
	 ...
	 */
	protected void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclReferenceResolveResult<ReferenceType> result) {
		try {
	 ...
	 */
	protected boolean tryToResolveIdentifierInObjectTree(String identifier, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EObject root, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclReferenceResolveResult<ReferenceType> result, boolean checkRootFirst) {
	...
	protected boolean tryToResolveIdentifierAsURI(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclReferenceResolveResult<ReferenceType> result) {
		org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
	...
	protected boolean tryToResolveIdentifierInGenModelRegistry(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclReferenceResolveResult<ReferenceType> result) {
		org.eclipse.emf.ecore.EClass type = reference.getEReferenceType();
	...
	protected boolean checkElement(org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EReference reference, int position, org.eclipse.emf.ecore.EClass type, String identifier, boolean resolveFuzzy, boolean checkStringWise, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclReferenceResolveResult<ReferenceType> result) {
		...
		if (exactMatch == null) {
			...
			if (similarMatch != null) {
				...
				result.addQuickFix(new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclChangeReferenceQuickFix("Replace with " + similarMatch, "IMG_TOOL_FORWARD", container, reference, oldTarget, element));
			}
			return true;
		}
	...
	protected String produceDeResolveErrorMessage(org.eclipse.emf.ecore.EObject refObject, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource) {
	...
	protected org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclReferenceCache getCache(org.eclipse.emf.ecore.EObject object) {
		org.eclipse.emf.ecore.EObject root = org.eclipse.emf.ecore.util.EcoreUtil.getRootContainer(object);
		org.eclipse.emf.common.notify.Adapter adapter = org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclEObjectUtil.getEAdapter(root, org.eclipselabs.simpleocl.resource.simpleocl.analysis.SimpleoclReferenceCache.class);
		org.eclipselabs.simpleocl.resource.simpleocl.analysis.SimpleoclReferenceCache cache = org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclCastUtil.cast(adapter);
		if (cache != null) {
			return cache;
		} else {
			// cache does not exist. create a new one.
			cache = new org.eclipselabs.simpleocl.resource.simpleocl.analysis.SimpleoclReferenceCache(nameProvider);
	...
	protected boolean isSimilar(String identifier, Object attributeValue) {
		if (attributeValue != null && attributeValue instanceof String) {
			String name = (String) attributeValue;
			if (org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.computeLevenshteinDistance(identifier, name) <= MAX_DISTANCE) {
				return true;
			}
		}
		return false;
