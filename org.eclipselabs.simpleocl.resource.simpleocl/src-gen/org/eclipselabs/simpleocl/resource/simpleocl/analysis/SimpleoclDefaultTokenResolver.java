 ...
 */
public class SimpleoclDefaultTokenResolver implements org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver {
	 ...
	 */
	public SimpleoclDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public SimpleoclDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclGrammarInformationProvider.INSTANCE.getKeywords()) {
