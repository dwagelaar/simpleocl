 ...
 * code).
 */
public class SimpleoclDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.debug.AbstractSimpleoclDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object>>();
	...
	public SimpleoclDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.encode('#', stack);
				org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage message = new org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage message = new org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_VARIABLES)) {
				...
				org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage message = new org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugMessage(org.eclipselabs.simpleocl.resource.simpleocl.debug.ESimpleoclDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object> pair = new org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclPair<String, Object>(name, value);
	...
	public org.eclipselabs.simpleocl.resource.simpleocl.debug.AbstractSimpleoclDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(org.eclipselabs.simpleocl.resource.simpleocl.debug.AbstractSimpleoclDebuggable debuggable) {
