...
public class SimpleoclStackFrame extends org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target;
	private String name;
	private int id;
	...
	public SimpleoclStackFrame(org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.decode(data, ',');
	...
	private org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclStackFrame other = (org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclStackFrame) obj;
		if (name == null) {
