 ...
 */
public class SimpleoclEnumerationTerminal extends org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public SimpleoclEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclCardinality cardinality, int mandatoryOccurrencesAfter) {
