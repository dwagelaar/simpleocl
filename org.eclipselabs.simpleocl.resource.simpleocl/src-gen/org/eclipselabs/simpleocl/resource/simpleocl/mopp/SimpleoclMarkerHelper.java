 ...
 * contains
 * <code>org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextDiagnostic</cod
 * e>s it uses the more precise information of this extended diagnostic type.
 */
public class SimpleoclMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object>> commands = new java.util.ArrayList<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object>> commandsToProcess = new java.util.ArrayList<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextDiagnostic diagnostic) {
		final org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclProblem problem = diagnostic.getProblem();
		org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemSeverity.ERROR) {
					...
					org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextDiagnostic textDiagnostic = (org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemType nextType : org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.eclipselabs.simpleocl.resource.simpleocl.SimpleoclEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});
