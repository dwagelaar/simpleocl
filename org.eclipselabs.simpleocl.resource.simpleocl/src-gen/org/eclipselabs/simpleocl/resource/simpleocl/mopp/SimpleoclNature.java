...
public class SimpleoclNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.eclipselabs.simpleocl.resource.simpleocl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
