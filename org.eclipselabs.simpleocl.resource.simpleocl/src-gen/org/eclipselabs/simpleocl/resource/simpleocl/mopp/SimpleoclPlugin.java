...
public class SimpleoclPlugin extends org.eclipse.core.runtime.Plugin {
	...
	public static final String PLUGIN_ID = "org.eclipselabs.simpleocl.resource.simpleocl";
	/**
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, SimpleoclPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, SimpleoclPlugin.PLUGIN_ID, message);
		}
