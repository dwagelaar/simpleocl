...
public class SimpleoclPrinter implements org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextPrinter {
	
	protected org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolverFactory tokenResolverFactory = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenResolverFactory();
	...
	public SimpleoclPrinter(java.io.OutputStream outputStream, org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTextResource resource) {
		super();
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_34_34_92");
			...
			if (count > 0) {
				Object o = element.eGet(element.eClass().getEStructuralFeature(org.eclipselabs.simpleocl.SimpleoclPackage.MODULE__NAME));
				if (o != null) {
					org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("TEXT");
					resolver.setOptions(getOptions());
					out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.eclipselabs.simpleocl.SimpleoclPackage.MODULE__NAME), element));
					out.print(" ");
				}
	...
	public void print_org_eclipselabs_simpleocl_OclMetamodel_1(org.eclipselabs.simpleocl.OclMetamodel element, String outertab, java.io.PrintWriter out, java.util.Map<String, Integer> printCountingMap) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("QUOTED_39_39_92");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_LocalVariable(org.eclipselabs.simpleocl.LocalVariable element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("EQ");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_RealExp(org.eclipselabs.simpleocl.RealExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("FLOAT");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_IntegerExp(org.eclipselabs.simpleocl.IntegerExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTEGER");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_OperatorCallExp(org.eclipselabs.simpleocl.OperatorCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLOP");
				resolver.setOptions(getOptions());
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("NEQ");
						resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_RelOpCallExp(org.eclipselabs.simpleocl.RelOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("RELOP");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_AddOpCallExp(org.eclipselabs.simpleocl.AddOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("ADDOP");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_IntOpCallExp(org.eclipselabs.simpleocl.IntOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTOP");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_MulOpCallExp(org.eclipselabs.simpleocl.MulOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("MULOP");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_NotOpCallExp(org.eclipselabs.simpleocl.NotOpCallExp element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("NOTOP");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_CollectionType(org.eclipselabs.simpleocl.CollectionType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("COLLECTIONTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_StringType(org.eclipselabs.simpleocl.StringType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("STRINGTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_BooleanType(org.eclipselabs.simpleocl.BooleanType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("BOOLEANTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_IntegerType(org.eclipselabs.simpleocl.IntegerType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("INTEGERTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_RealType(org.eclipselabs.simpleocl.RealType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("REALTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_BagType(org.eclipselabs.simpleocl.BagType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("BAGTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_OrderedSetType(org.eclipselabs.simpleocl.OrderedSetType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("ORDEREDSETTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_SequenceType(org.eclipselabs.simpleocl.SequenceType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("SEQUENCETYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_SetType(org.eclipselabs.simpleocl.SetType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("SETTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_OclAnyType(org.eclipselabs.simpleocl.OclAnyType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCLANYTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_OclType(org.eclipselabs.simpleocl.OclType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("OCLTYPE");
				resolver.setOptions(getOptions());
		...
		switch(alt) {
			case 1:			{
				...
				if (count > 0) {
					...
					if (o != null) {
						org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("TUPLE");
						resolver.setOptions(getOptions());
			...
			if (count > 0) {
				Object o = element.eGet(element.eClass().getEStructuralFeature(org.eclipselabs.simpleocl.SimpleoclPackage.TUPLE_TYPE__NAME));
				if (o != null) {
					org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("TUPLETYPE");
					resolver.setOptions(getOptions());
					out.print(resolver.deResolve((Object) o, element.eClass().getEStructuralFeature(org.eclipselabs.simpleocl.SimpleoclPackage.TUPLE_TYPE__NAME), element));
					out.print(" ");
				}
	...
	public void print_org_eclipselabs_simpleocl_MapType(org.eclipselabs.simpleocl.MapType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("MAPTYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_LambdaType(org.eclipselabs.simpleocl.LambdaType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("LAMBDATYPE");
				resolver.setOptions(getOptions());
	...
	public void print_org_eclipselabs_simpleocl_EnvType(org.eclipselabs.simpleocl.EnvType element, String outertab, java.io.PrintWriter out) {
		...
		if (count > 0) {
			...
			if (o != null) {
				org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver resolver = tokenResolverFactory.createTokenResolver("ENVTYPE");
				resolver.setOptions(getOptions());
