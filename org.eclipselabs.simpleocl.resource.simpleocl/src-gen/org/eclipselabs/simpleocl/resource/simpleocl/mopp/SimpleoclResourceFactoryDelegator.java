...
public class SimpleoclResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	protected void init() {
		...
		if (new org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclResourceFactory());
		}
	}
