...
public class SimpleoclTokenStyleInformationProvider {
	...
	public org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenStyle getDefaultTokenStyle(String tokenName) {
		if ("NOTOP".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x80, 0x00, 0x40}, null, true, false, false, false);
		}
		...
		if ("COMMENT".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x53, 0x87, 0x6D}, null, false, false, false, false);
		}
		if ("FLOAT".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x2A, 0x00, 0xFF}, null, false, false, false, false);
		}
		if ("INTEGER".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x2A, 0x00, 0xFF}, null, false, false, false, false);
		}
		if ("STRINGTYPE".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x00, 0xC0, 0x00}, null, false, false, false, false);
		}
		...
		if ("true".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x00, 0xD0, 0xFF}, null, false, false, false, false);
		}
		if ("false".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x00, 0xD0, 0xFF}, null, false, false, false, false);
		}
		if ("iterate".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x00, 0x00, 0x00}, null, false, false, false, false);
		}
		if ("module".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x80, 0x00, 0x55}, null, true, false, false, false);
		}
		...
		if ("TASK_ITEM".equals(tokenName)) {
			return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenStyle(new int[] {0x7F, 0x9F, 0xBF}, null, true, false, false, false);
		}
		return null;
	}
