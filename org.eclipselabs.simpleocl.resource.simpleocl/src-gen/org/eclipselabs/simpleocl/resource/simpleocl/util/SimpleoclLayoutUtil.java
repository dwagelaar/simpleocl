...
public class SimpleoclLayoutUtil {
	...
	public void transferLayoutInformationToModel(org.eclipse.emf.ecore.EObject element) {
		...
		for (java.util.Iterator<org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(org.eclipse.emf.ecore.EObject element) {
		...
		if (layoutReference != null) {
			...
			for (java.util.Iterator<org.eclipse.emf.ecore.EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public org.eclipse.emf.ecore.EObject createLayoutInformationModelElement(org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation layoutInformation, org.eclipse.emf.ecore.EPackage layoutPackage) {
		...
		org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation createLayoutInformation(org.eclipse.emf.ecore.EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclSyntaxElement syntaxElement = org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclPlaceholder) {
			org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclPlaceholder placeholder = (org.eclipselabs.simpleocl.resource.simpleocl.grammar.SimpleoclPlaceholder) syntaxElement;
			org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolver tokenResolver = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.eclipselabs.simpleocl.resource.simpleocl.ISimpleoclTokenResolveResult result = new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclLayoutInformationAdapter getLayoutInformationAdapter(org.eclipse.emf.ecore.EObject element) {
