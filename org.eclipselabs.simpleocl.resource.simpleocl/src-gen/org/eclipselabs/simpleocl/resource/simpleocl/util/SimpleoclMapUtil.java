	...
	public static <K> void putAndMergeKeys(java.util.Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof java.util.List<?>) {
				...
				java.util.List<Object> currentValueAsObjectList = org.eclipselabs.simpleocl.resource.simpleocl.util.SimpleoclListUtil.copySafelyToObjectList(currentValueAsList);
