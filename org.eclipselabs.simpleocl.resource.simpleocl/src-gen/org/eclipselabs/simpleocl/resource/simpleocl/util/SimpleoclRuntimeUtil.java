 ...
 */
public class SimpleoclRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.eclipselabs.simpleocl.resource.simpleocl.mopp.SimpleoclPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {
