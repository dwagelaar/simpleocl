...
public class SimpleoclLineBreakpoint extends AtlBreakpoint {
	...
	public void install(org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target) {
		try {
	...
	public void remove(org.eclipselabs.simpleocl.resource.simpleocl.debug.SimpleoclDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
