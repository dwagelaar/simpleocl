 ...
 * <ul>
 *   <li>{@link org.eclipselabs.simpleocl.impl.BooleanExpImpl#isBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpImpl extends PrimitiveExpImpl implements BooleanExp {
	...
	protected EClass eStaticClass() {
		return SimpleoclPackage.Literals.BOOLEAN_EXP;
	}
	...
	public void setBooleanSymbol(boolean newBooleanSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleoclPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL, oldBooleanSymbol, booleanSymbol));
	}
