 ...
 * <ul>
 *   <li>{@link org.eclipselabs.simpleocl.impl.IteratorImpl#getLoopExpr <em>Loop Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IteratorImpl extends VariableDeclarationImpl implements Iterator {
	...
	protected EClass eStaticClass() {
		return SimpleoclPackage.Literals.ITERATOR;
	}
	...
	public NotificationChain basicSetLoopExpr(LoopExp newLoopExpr, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLoopExpr, SimpleoclPackage.ITERATOR__LOOP_EXPR, msgs);
		return msgs;
	}
	...
	public void setLoopExpr(LoopExp newLoopExpr) {
		if (newLoopExpr != eInternalContainer() || (eContainerFeatureID() != SimpleoclPackage.ITERATOR__LOOP_EXPR && newLoopExpr != null)) {
			...
			if (newLoopExpr != null)
				msgs = ((InternalEObject)newLoopExpr).eInverseAdd(this, SimpleoclPackage.LOOP_EXP__ITERATORS, LoopExp.class, msgs);
			msgs = basicSetLoopExpr(newLoopExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleoclPackage.ITERATOR__LOOP_EXPR, newLoopExpr, newLoopExpr));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimpleoclPackage.ITERATOR__LOOP_EXPR:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case SimpleoclPackage.ITERATOR__LOOP_EXPR:
				return eInternalContainer().eInverseRemove(this, SimpleoclPackage.LOOP_EXP__ITERATORS, LoopExp.class, msgs);
		}
