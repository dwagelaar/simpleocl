 ...
 * <ul>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getDefinitions <em>Definitions</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getOclExpression <em>Ocl Expression</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getOperation <em>Operation</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getMapType2 <em>Map Type2</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getAttribute <em>Attribute</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getMapType <em>Map Type</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getCollectionTypes <em>Collection Types</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getTupleTypeAttribute <em>Tuple Type Attribute</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getVariableDeclaration <em>Variable Declaration</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getLambdaReturnType <em>Lambda Return Type</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getLambdaArgType <em>Lambda Arg Type</em>}</li>
 *   <li>{@link org.eclipselabs.simpleocl.impl.OclTypeImpl#getStaticPropertyCall <em>Static Property Call</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
