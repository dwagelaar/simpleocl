 ...
 * <ul>
 *   <li>{@link org.eclipselabs.simpleocl.impl.TupleExpImpl#getTuplePart <em>Tuple Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleExpImpl extends OclExpressionImpl implements TupleExp {
	...
	protected EClass eStaticClass() {
		return SimpleoclPackage.Literals.TUPLE_EXP;
	}
	...
	public EList<TuplePart> getTuplePart() {
		if (tuplePart == null) {
			tuplePart = new EObjectContainmentWithInverseEList<TuplePart>(TuplePart.class, this, SimpleoclPackage.TUPLE_EXP__TUPLE_PART, SimpleoclPackage.TUPLE_PART__TUPLE);
		}
		return tuplePart;
	}
