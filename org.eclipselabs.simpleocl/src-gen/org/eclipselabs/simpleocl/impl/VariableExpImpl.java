 ...
 * <ul>
 *   <li>{@link org.eclipselabs.simpleocl.impl.VariableExpImpl#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableExpImpl extends OclExpressionImpl implements VariableExp {
	...
	protected EClass eStaticClass() {
		return SimpleoclPackage.Literals.VARIABLE_EXP;
	}
		...
		if (referredVariable != null && referredVariable.eIsProxy()) {
			...
			if (referredVariable != oldReferredVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SimpleoclPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, referredVariable));
			}
		}
	...
	public NotificationChain basicSetReferredVariable(VariableDeclaration newReferredVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleoclPackage.VARIABLE_EXP__REFERRED_VARIABLE, oldReferredVariable, newReferredVariable);
	...
	public void setReferredVariable(VariableDeclaration newReferredVariable) {
		if (newReferredVariable != referredVariable) {
			...
			if (referredVariable != null)
				msgs = ((InternalEObject)referredVariable).eInverseRemove(this, SimpleoclPackage.VARIABLE_DECLARATION__VARIABLE_EXP, VariableDeclaration.class, msgs);
			if (newReferredVariable != null)
				msgs = ((InternalEObject)newReferredVariable).eInverseAdd(this, SimpleoclPackage.VARIABLE_DECLARATION__VARIABLE_EXP, VariableDeclaration.class, msgs);
			msgs = basicSetReferredVariable(newReferredVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimpleoclPackage.VARIABLE_EXP__REFERRED_VARIABLE, newReferredVariable, newReferredVariable));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimpleoclPackage.VARIABLE_EXP__REFERRED_VARIABLE:
				if (referredVariable != null)
					msgs = ((InternalEObject)referredVariable).eInverseRemove(this, SimpleoclPackage.VARIABLE_DECLARATION__VARIABLE_EXP, VariableDeclaration.class, msgs);
